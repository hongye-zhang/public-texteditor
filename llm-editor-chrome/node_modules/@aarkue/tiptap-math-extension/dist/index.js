import { Node, InputRule, PasteRule, mergeAttributes, Extension } from '@tiptap/core';
...
function updateEvaluation(latex, id, resultSpan, showEvalResult, editorStorage) {
    ...
    const updateResultSpan = () => {
        var _a;
        if (evalRes === null || evalRes === undefined ? undefined : evalRes.result) {
            if (((_a = evalRes.result.toString().split(".")[1]) === null || _a === undefined ? undefined : _a.length) > 5) {
    ...
    updateResultSpan();
    if (evalRes === null || evalRes === undefined ? undefined : evalRes.variablesUsed) {
...
const DEFAULT_OPTIONS = { addInlineMath: true, evaluation: false, delimiters: "dollar" };
...
const InlineMathNode = Node.create({
    ...
    addNodeView() {
        return ({ HTMLAttributes, node, getPos, editor }) => {
            ...
            katex.render(latex, span, Object.assign({ displayMode: displayMode, throwOnError: false }, ((_a = this.options.katexOptions) !== null && _a !== undefined ? _a : {})));
...
function getDelimiter(mode, position, options) {
    ...
    if (options.delimiters === undefined || options.delimiters === "dollar") {
        ...
        if (mode === "inline") {
            if (position === "start") {
                return (_a = options.delimiters.inlineStart) !== null && _a !== undefined ? _a : "$";
            }
            else {
                return (_b = options.delimiters.inlineEnd) !== null && _b !== undefined ? _b : "$";
            }
        }
        else {
            if (position === "start") {
                return (_c = options.delimiters.blockStart) !== null && _c !== undefined ? _c : "$$";
            }
            else {
                return (_d = options.delimiters.blockEnd) !== null && _d !== undefined ? _d : "$$";
            }
        }
    }
}
